...
create table if not exists Active_Subscription (
    ...
    next_renewal_date datetime not null default timestampadd(day, now(), 30),
...
create table if not exists Survey_Response_Location (
    ...
    survey_response_location varchar(512) unique, # where on cloud storage
...
create table if not exists Survey_Response_Location_Copy (
    ...
    survey_response_location_copy varchar(512) unique,
